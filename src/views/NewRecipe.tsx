        ...
        <>
            <div className="h-screen w-full ">
                <div className="flex justify-end h-[10%] px-6 items-center">
                    <Link to="/recetas" className="text-center py-2 px-4 bg-white text-black  rounded-full shadow hover:bg-black hover:text-white cursor-pointer">Regresar a Recetas</Link>
                </div>
